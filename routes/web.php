...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::resource('pharmacies',      \App\Http\Controllers\Web\PharmacyController::class)->only(['index','create','store','edit','update','destroy']);
        ...
        Route::resource('warehouses',      \App\Http\Controllers\Web\WarehouseController::class)->only(['index','create','store','edit','update','destroy']);
    ...
    Route::middleware('role:admin,company')->group(function () {
        ...
        Route::resource('sales',    \App\Http\Controllers\Web\SaleController::class)->only(['index','create','store']);
...
// Keep old SPA URL alive (temporary redirect)
