...
<div class="border-t border-slate-200 pt-4 mt-2">
    <label class="block text-sm font-medium text-slate-700 mb-1">
        كلمة مرور رؤية البيانات الحساسة
        <span class="text-slate-400 font-normal text-xs">(اتركها فارغة إذا لم تغيّرها)</span>
    </label>
    <input type="password" name="sensitive_view_password" autocomplete="new-password"
        class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('sensitive_view_password') border-red-400 @enderror">
    @error('sensitive_view_password')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
    <p class="text-xs text-slate-400 mt-1">يستخدمها مستخدم الشركة لرؤية أسماء الصيدليات الحساسة</p>
</div>
