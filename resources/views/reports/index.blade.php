...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
    <form action="{{ route('reports.index') }}" method="GET" class="flex flex-wrap gap-4 items-end">
        ...
        <div class="flex-1 min-w-[200px]">
            ...
            <select name="company_id" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="text-left">
            <p class="text-2xl font-bold text-emerald-600">{{ number_format($additional_kpis['top_pharmacy']['revenue'], 2) }} ج.م</p>
            ...
            <tbody class="divide-y divide-slate-200">
                @forelse($additional_kpis['revenue_per_product'] as $product)
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-sm font-bold text-emerald-600">{{ number_format($product['revenue'], 2) }} ج.م</td>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-200">
                @forelse($charts['stats_by_company'] as $company)
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-3 text-sm font-medium text-slate-800">{{ $company['company_name'] }}</td>
                        ...
                        <td class="px-4 py-3 text-sm font-bold text-emerald-600">{{ number_format($company['total_revenue'], 2) }} ج.م</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="4" class="px-4 py-8 text-center text-slate-500">
